package com.planon.iwms.testbase;
...
public class TestBase {
	...
	public void init() throws IOException {
		extent = new ExtentReports(System.getProperty("user.dir")+"//src//test//java//com//planon//iwms//screenshots//test.html");
	...
	public void loadPropertiesFile() throws IOException {
		f = new File(System.getProperty("user.dir") + "//src//test//java//com//planon//iwms//config//config.properties");
	...
	public WebDriver selectBrowser(String browser) {
		if (browser.equals("firefox") || browser.equals("FIREFOX")) {
			System.setProperty("webdriver.gecko.driver", System.getProperty("user.dir") + "\\src\\com\\\browsers\\geckodriver.exe");
			driver = new FirefoxDriver();
			driver.manage().window().maximize();
			return driver;
		} else if (browser.equals("chrome") || browser.equals("CHROME")) {
			System.out.println("chrome browser");
			System.setProperty("webdriver.chrome.driver", System.getProperty("user.dir") + "\\src\\com\\\browsers\\chromedriver.exe");
			driver = new ChromeDriver();
			driver.manage().window().maximize();
			return driver;
		} else if (browser.equals("ie") || browser.equals("IE")) {
			System.setProperty("webdriver.ie.driver", System.getProperty("user.dir") + "\\src\\com\\\browsers\\IEDriverServer.exe");
	...
	public  void getScreenShot(String fileName) throws IOException {
		...
		FileUtils.copyFile(outputFile, new File(System.getProperty("user.dir") + "//src//test//java//com//planon//iw ?ms//screenshots//" + fileName + ".jpg"));
	}
	...
	public static void updateResult(int indexSI, String testCaseName, String testCaseStatus, String scriptName) throws IOException {
		...
		String resultFile = userDirector + "//src//test//java//com//planon//iwms//report//TestHtmlReport.html";
